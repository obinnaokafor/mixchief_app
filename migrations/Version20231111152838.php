 ...
 */
final class Version20231111152838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP customer');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD customer VARCHAR(255) DEFAULT NULL');
