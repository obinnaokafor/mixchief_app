 ...
 */
final class Version20231111133438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD address VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) NOT NULL');
        ...
        // $this->addSql('ALTER TABLE orders ADD customer_id INT DEFAULT NULL, DROP customer');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer DROP address, CHANGE email email VARCHAR(255) DEFAULT NULL');
